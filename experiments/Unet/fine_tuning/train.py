...
model.load_state_dict(torch.load("models/3d_unet_checkpoints/best_model_3D_unet_pretrained.pth"))
...
for epoch in range(1, num_epochs + 1):
    ...
    if avg_val_loss < best_val_loss:
        ...
        best_model_path = os.path.join(
            checkpoint_dir, f"best_model_3D_unet_xcat.pth")
...
final_path = os.path.join(
    checkpoint_dir, f"final_model_{timestamp}_3D_unet_xcat.pth")
