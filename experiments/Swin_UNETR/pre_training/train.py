from core.data import make_data_list_pre_training as make_data_list
...
checkpoint_dir = "models/swin_unetr_checkpoints" # save checkpoints dir
...
for epoch in range(1, num_epochs + 1):
    ...
    if avg_val_loss < best_val_loss:
        ...
        best_model_path = os.path.join(
            checkpoint_dir, f"best_model_swin_unetr_pretrained.pth")
...
final_path = os.path.join(
    checkpoint_dir, f"final_model_{timestamp}_swin_unetr_pretraining.pth")
